...
local config = {
    ...
    -- color_scheme removed – using default colors
    colors = {
        cursor_bg = "#bbbbbb",   -- light gray cursor background
        cursor_fg = "black",      -- black text inside cursor
    },
    inactive_pane_hsb = {
        hue = 1.0,
        saturation = 1.0,
    ...
    -- font_size = 16.0,   -- (commented out – uncomment if you want)
    launch_menu = {},
    ...
    keys = {
        ...
        { key = "x", mods = "LEADER",       action="TogglePaneZoomState" },
        ...
        { key = "L", mods = "LEADER|SHIFT", action=wezterm.action{AdjustPaneSize={"Left", 5}}},
        { key = "D", mods = "LEADER|SHIFT", action=wezterm.action{AdjustPaneSize={"Down", 5}}},
        { key = "U", mods = "LEADER|SHIFT", action=wezterm.action{AdjustPaneSize={"Up", 5}}},
        { key = "R", mods = "LEADER|SHIFT", action=wezterm.action{AdjustPaneSize={"Right", 5}}},
        ...
        { key = "z", mods = "LEADER",       action=wezterm.action{CloseCurrentPane={confirm=true}}},
